...
namespace CSharpCpu.Cpus.Z80
{
	...
	public sealed partial class InstructionTable : IInstructionTable
	{
		...
		private static InstructionInfo[] CreateInstructionList(Version Version)
		{
			...
			Instructions.Add(Instruction("8F         ", "ADC A,A           "));
			Instructions.Add(Instruction("88         ", "ADC A,B           "));
			Instructions.Add(Instruction("89         ", "ADC A,C           "));
			Instructions.Add(Instruction("8A         ", "ADC A,D           "));
			Instructions.Add(Instruction("8B         ", "ADC A,E           "));
			Instructions.Add(Instruction("8C         ", "ADC A,H           "));
			Instructions.Add(Instruction("DD8C       ", "ADC A,IXh         "));
			Instructions.Add(Instruction("DD8D       ", "ADC A,IXl         "));
			Instructions.Add(Instruction("FD8C       ", "ADC A,IYh         "));
			Instructions.Add(Instruction("FD8D       ", "ADC A,IYl         "));
			Instructions.Add(Instruction("8D         ", "ADC A,L           "));
